...
QUOTES = [
    # Verified quotes from the Pali Canon
    ("Mind is the forerunner of all actions.\nIf one speaks or acts with a corrupt mind, suffering follows,\nas the wheel follows the hoof of an ox.", "Dhammapada, v.1"),
    ("Hatred is never appeased by hatred in this world.\nBy non-hatred alone is hatred appeased.\nThis is a law eternal.", "Dhammapada, v.5"),
    ("Heedfulness is the path to the Deathless.\nHeedlessness is the path to death.\nThe heedful die not. The heedless are as if dead already.", "Dhammapada, v.21"),
    ("Better than a thousand meaningless words\nis one meaningful word that on hearing brings peace.", "Dhammapada, v.100"),
    ("Greater in battle than the man who would conquer\na thousand-thousand men, is he who would conquer\njust one — himself.", "Dhammapada, v.103"),
    ("One truly is the protector of oneself;\nwho else could the protector be?\nWith oneself fully controlled,\none gains a mastery that is hard to gain.", "Dhammapada, v.160"),
    ("By oneself is evil done; by oneself is one defiled.\nBy oneself is evil left undone; by oneself is one made pure.\nPurity and impurity depend on oneself;\nno one can purify another.", "Dhammapada, v.165"),
    ("The non-doing of any evil,\nthe performance of what is skillful,\nthe cleansing of one's own mind —\nthis is the teaching of the Awakened.", "Dhammapada, v.183"),
    ("All conditioned things are impermanent.\nWhen one sees this with wisdom,\none turns away from suffering.\nThis is the path to purification.", "Dhammapada, v.277"),
    ("You yourselves must strive;\nthe Buddhas only point the way.\nThose meditative ones who tread the path\nare released from the bonds of Mara.", "Dhammapada, v.276"),
    ("As a mother would risk her life to protect her child,\nher only child, even so should one cultivate\na limitless heart with regard to all beings.", "Karaniya Metta Sutta, Sn 1.8"),
    ("Just as the great ocean has a single taste —\nthe taste of salt — so also this Dhamma\nhas a single taste: the taste of release.", "Udana 5.5"),
    ("I have taught the Dhamma compared to a raft,\nfor the purpose of crossing over, not for the purpose of holding onto.", "Majjhima Nikaya 22"),
    ("When touched with a feeling of pain, the wise person\nneither sorrows nor grieves nor laments.\nThis is the difference between the wise and the unwise.", "Samyutta Nikaya 36.6"),
    ("It is just within this fathom-long body,\nwith its perception and intellect,\nthat I declare there is the cosmos,\nthe origination of the cosmos, and the path to its cessation.", "Anguttara Nikaya 4.45"),
    # Thich Nhat Hanh — contemporary teacher, clearly attributed
